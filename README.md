# Knife vSphere
[<img
src="https://travis-ci.org/chef-partners/knife-vsphere.svg?branch=master"
alt="Build Status" />](https://travis-ci.org/chef-partners/knife-vsphere)
...
checking: ERROR: OpenSSL::SSL::SSLError: SSL_connect returned=1 errno=0
...
"https://www.vmware.com/support/developer/vc-sdk/visdk25pubs/ReferenceGuide/vi
m.vm.ToolsConfigInfo.html" for available properties and types.
...
Authors
:   Ezra Pagel <ezra@cpan.org> Jesse Campbell <hikeit@gmail.com> John Williams
    <john@37signals.com> Ian Delahorne <ian@scmventures.se> Bethany Erskine
    <bethany@paperlesspost.com> Adrian Stanila <adrian.stanila@sacx.net>
    Raducu Deaconu <rhadoo_io@yahoo.com> Leeor Aharon
